...
public class AvatarImageView extends AppCompatImageView {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        roundCorner = a.getDimensionPixelSize(R.styleable.AvatarImageView_img_roundCorner, (int) ImageUtils.fromDip(context, DEFAULT_CORNER_RADIUS));
        strokeColor = a.getColor(R.styleable.AvatarImageView_img_strokeColor, DEFAULT_STROKE_COLOR);
        strokeWidth = a.getDimensionPixelSize(R.styleable.AvatarImageView_img_strokeWidth, (int) ImageUtils.fromDip(context, DEFAULT_STROKE_WIDTH));
        a.recycle();
